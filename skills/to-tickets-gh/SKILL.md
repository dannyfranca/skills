...
Publish blockers before dependents. Publishing is complete when every approved leaf belongs to the Epic, every dependency edge exists, and every unblocked leaf is labeled `ready-for-agent`.
